...
This document lists the necessary steps to set up a Linux (Ubuntu 22.04) development environment on a Windows 11 machine. Please contact Christian Brice ([email](mailto:brice.c.67b9@m.isct.ac.jp)) with any questions or revision suggestions.
